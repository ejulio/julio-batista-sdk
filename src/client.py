...
class Client:
    ...
    def get_movies(
        ...
        return self._get_api_resource("movie", Movie.from_api_response, sorting, pagination, filtering)
    ...
    def get_quotes(
        ...
        return self._get_api_resource("quote", Quote.from_api_response, sorting, pagination, filtering)
